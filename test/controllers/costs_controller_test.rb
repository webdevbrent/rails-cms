...
class CostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post costs_url, params: { cost: { age: @cost.age, babysitter: @cost.babysitter, body: @cost.body, title: @cost.title } }
    end
  ...
  test "should update cost" do
    patch cost_url(@cost), params: { cost: { age: @cost.age, babysitter: @cost.babysitter, body: @cost.body, title: @cost.title } }
